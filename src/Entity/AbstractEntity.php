 ...
 * @package Mepatek\Entity
 */
abstract class AbstractEntity extends Object implements ArrayAccess, IteratorAggregate
{
	/**
	...
	protected function Rowguid($rowguid)
	{
		// is correct uuid ?
		if (Strings::match(
			$rowguid, '/^\{{0,1}[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12}\}{0,1}$/i'
		)
		) {
